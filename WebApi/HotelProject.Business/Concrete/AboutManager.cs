    ...
    public class AboutManager : IAboutService
    {
        ...
        public void Delete(About entity)
        {
            if (entity != null)
            {
                ...
                _unitOfWork.About.Delete(entity);
                _unitOfWork.SaveChanges();
            }
        }
        ...
        public async Task DeleteAsync(About entity)
        {
            if (entity != null)
            {
                entity.IsActive = false;
                entity.IsDeleted = true;
                await _unitOfWork.About.DeleteAsync(entity);
                await _unitOfWork.SaveChangesAsync();
            }
        }
        ...
        {
            return filter == null ?
                _unitOfWork.About.GetAll() :
                _unitOfWork.About.GetAll(filter);
        }
        ...
        {
            return filter == null ?
                await _unitOfWork.About.GetCountAsync() :
                await _unitOfWork.About.GetCountAsync(filter);
        }
        ...
        public Task<About?> GetWithFilterAsync(Expression<Func<About, bool>>? predicate = null, params Expression<Func<About, object>>[] includeProperties)
        {
            return _unitOfWork.About.GetWithFilterAsync(predicate, includeProperties);
        }
